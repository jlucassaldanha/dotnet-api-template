...
echo "1. Criando Solução..."

dotnet new sln -n $PROJECT_NAME


echo "2. Criando Projetos (Apresentação, Domínio, Casos de Uso e Infraestrutura)..."
...
echo "3. Adicionando projetos à Solução..."
...
echo "4. Configurando Referências (Dependency Inversion)..."
...
echo "5. Instalando Dependências do Entity Framework e PostgreSQL..."
...
echo "6. Adicionando .gitignore e iniciando repositório git"
